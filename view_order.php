...
?>
<div class="" style="min-height:64.7vh; ">
    <div class="py-3 ">
        <div class="container">
            <h3 class="text-dark">Home / My Order Details</h3>
        </div>
    </div>
    <div class="py-5">
        <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card shadow-lg border-0">
                            <div class="card-header bg-danger text-white display-6 text-center py-3">
                                View Order
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 px-4">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                // $order_query = "SELECT o.id as oid, o.tracking_no, o.user_id, oi.*,p.* FROM orders o, order_items oi, product p WHERE o.user_id ='$userId' AND oi.order_id='o.id' AND p.id='oi.prod_id' AND o.tracking_no='$tracking_no'";
